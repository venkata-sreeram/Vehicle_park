...
<section class="our-speaker-area bg-img bg-gradient-overlay section-padding-100-60 sreeram" id="speakers">
  ...
  <div class="imgcontainer">
    <img src="https://www.utshockey.org/wp-content/uploads/2015/11/RegisterNow_small.jpg"  >
  </div>

  <div class="containers">
    <label for="Name"><b style="color: white; font-size: 30px;">Name</b></label>
    <input type="text" placeholder="Enter Your Name" name="name" required>
    <label for="uname"><b style="color: white; font-size: 30px;">Phone Number</b></label>
    <input type="text" placeholder="Enter Your phone" name="phone" required>
    <label for="uname"><b style="color: white; font-size: 30px;">Address</b></label>
    ...
    <label>
       <b style="color: white; font-size: 30px;"><a href="login.php">  Already registered ! Log in here</b></a>
    </label>
  </div>
</form>
